...
function ConfirmRidePopup(props) {
  ...
  return (
    ...
    <form onSubmit={(e)=>{submitHandler(e)}} className='w-full'>
        <input type="number" placeholder='Enter OTP' onChange={()=>{setOtp(e.target.value)}}  value={otp} className='bg-[#eee] mb-3 px-6 py-3 font-mono text-base rounded-lg mt-4 w-full'/>
      <Link to='/captainriding' className="w-full text-lg mt-5 flex justify-center items-center  bg-green-500 text-white font-semibold p-3 rounded-lg">
        Confirm
      </Link>
