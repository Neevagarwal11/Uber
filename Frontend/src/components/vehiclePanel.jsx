  ...
  return (
    <div>
        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
          ...
          <div onClick={()=>{props.setConfirmedVehicle(true) , props.setVehiclePanel(false)}} className='flex active:border-2 active:border-black active:bg-gray-100 mb-2 rounded-xl items-center w-full p-3  justify-between'>
          ...
          <div onClick={()=>{props.setConfirmedVehicle(true)}} className='flex  mb-2 active:border-2 active:bg-gray-100 active:border-black rounded-xl items-center w-full p-3  justify-between'>
          ...
          <div onClick={()=>{props.setConfirmedVehicle(true)}} className='flex  mb-2 active:border-2 active:border-black rounded-xl items-center w-full p-3  justify-between'>
